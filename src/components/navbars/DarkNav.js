...
export default function DarkNav() {
  return (
    <div className="flex bg-[#252B42] h-11 py-9 px-3 justify-center items-center font-['Montserrat', sans-serif] text-sm text-[#FFFFFF] font-bold leading-6 tracking-widest">
