...
import arrow from "../../assets/contactPage/Arrow 2.svg";
import { Link } from "react-router-dom";

export default function ContactPrice() {
  return (
    <div>
      <div className="flex flex-col items-center text-center pb-20 text-[#252B42]">
        ...
        <div className="flex flex-col gap-9 font-bold mt-2">
          ...
          <Link
            to="/pricing"
            className="bg-[#23A6F0] rounded text-white py-[15px] px-10 text-sm w-[186px] m-auto"
          >
            Try it free now
          </Link>
        </div>
